...
Live asset: `public/products/category-cards/tank-card-g2-z660.png`, at
...
| --- | --- | --- | --- |
| z1000 | 50.8% of box | 32.3% | none |
| z900 | 56.4% | 35.9% | none |
| z850 | 59.8% | 38.0% | none |
| z820 | 62.0% | 39.4% | none — largest that survives hover |
| z800 | 63.5% | 40.4% | 2px |
| z780 | 65.2% | 41.4% | 6px |
| z750 | 67.8% | 43.1% | 13px |
| z720 | 70.6% | 44.9% | 21px |
| **g2-z660 (LIVE)** | **76.7%** | **49.1%** | **37px** |
| z620 | 82.0% | 52.1% | 51px |

z660 is live deliberately: the brand team's reference framing has the tanks
filling most of the card, and the hover-clean options (z820 and up) top out at
62% of the box, which reads noticeably small against the five pipe cards. 37px
is in the same range as the 33px clip R4 was knowingly shipped with. **Do not
