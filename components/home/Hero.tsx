        ...
        <div className="container-edge relative z-10 flex flex-col gap-[60px] pb-12 sm:gap-10 sm:pb-16 md:gap-12 lg:gap-[60px]">
          ...
          <div className="flex max-w-2xl flex-col gap-[13px] sm:gap-5">
            ...
            <h1 className="text-balance font-display text-[36px] font-light uppercase leading-[1.02] tracking-[0.209px] text-white sm:text-3xl sm:leading-[1.1] sm:tracking-tight md:text-4xl md:leading-[1.08] lg:text-5xl lg:leading-[1.05] xl:text-6xl xl:leading-[1.02] xl:tracking-[0.32px]">
              ...
              {/* Weight 700 at every width, colour inherited from the `h1`
                  (white). Node 1300:6513 draws this span
                  `Anek_Devanagari:Regular`, and it was briefly built at 400 on
                  mobile; a supplied spec then set 700, which is what stands.
                  That spec also called for `#F28000`, which was applied and
                  then reverted on request — the colour stays as it was.

                  Everything else in that spec (36px / 102% / 0.209px /
                  uppercase / Anek) already comes from the `h1`, so this span
                  carries nothing but the weight. */}
