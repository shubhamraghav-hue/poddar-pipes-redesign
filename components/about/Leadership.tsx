  ...
  return (
    <section id="leadership" className="bg-paper-2 py-24 md:py-28">
      <div className="container-edge">
        <SectionHeading eyebrow="Leadership" title="The team steering five decades of engineering." />
        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {team.map((member, i) => (
            <RevealOnScroll key={member.id} delay={i * 0.08}>
              <div className="group rounded-2xl border border-slate-200/70 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-ocean-900/5">
                ...
                <p className="mt-1 text-sm font-medium text-ocean-700">{member.role}</p>
