    ...
    <section className="bg-ink relative flex min-h-[100svh] flex-col overflow-hidden text-white">
      ...
      <div className="container-edge relative z-10 flex flex-1 items-center justify-center py-8">
        <div className="relative flex w-full max-w-2xl flex-col items-center gap-[min(2.6vh,1.15rem)] text-center">
          ...
          {/*
            FIX: changed from `relative px-3 py-2` (block) to
            `relative inline-flex flex-col items-center px-3 py-2` so
            the div's height collapses to exactly its text content.
            Previously the block div stretched to the full column width,
            pushing the absolute bottom-right bracket far below "SOON".
          */}
          <div
...
//         />
//       </svg>
//       <span className="text-xs font-bold tracking-widest text-amber-500 uppercase">{label}</span>
//     </div>
//   );
// }
